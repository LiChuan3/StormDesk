...
export ENV_ROOT=${ENV_ROOT:-/data_small/user_envs/USER/llm-tc}
export PY=${PY:-$ENV_ROOT/bin/python}
...
export STORMDESK_WORK=${STORMDESK_WORK:-/data/USER/projects/stormdesk_runtime}
